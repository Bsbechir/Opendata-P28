# fusion des 3 sources (RTE xlsx + ENTSOE + RTE API) en un seul CSV
...
# dedup : meme id + meme version = doublon
...
# dedup cross-source : meme reacteur + meme jour = doublon
# on garde RTE xlsx en priorite
df_final["_dedup_key"] = (
